/* NODO QUE DECIDE SI USAREMOS EL GROUND TRUTH O LA LOCALIZACIÓN IMPLEMENTADA PARA CONTROLAR EL UAV
   LOS TOPICS /state Y /imu SON EMPLEADOS INTERNAMENTE POR EL CONTROLADOR PARA DIRIGIR EL VUELO DEL UAV

   CON ESTE NODO, SE ELIGE QUÉ LOCALIZACIÓN QUEREMOS EMPLEAR PARA CONTROLAR EL UAV

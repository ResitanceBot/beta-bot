...
public:
  ...
  void EKFPrediction(double AngVelX, double AngVelY, double AngVelZ,
                     double VO_x, double VO_y, double VO_z, double VO_vx,
                     double VO_vy, double VO_vz, double VO_r, double VO_p,
                     double VO_yaw, double VO_var_x, double VO_var_y,
  ...
  void EKFUpdate(double dist1, double dist2, double dist3, double dist4,
                 ...
                 double dist4_ant, double xGPS, double yGPS, double zBar,
                 double xGPS_ant, double yGPS_ant, double zBar_ant, double magX,
